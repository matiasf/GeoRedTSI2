...
public class MemberController {
   ...
   public String register() throws Exception {
	  ...
	  boolean loginAdminSistema = this.newMember.getName().equals("admin") && this.newMember.getEmail().equals("admin@admin.admin");
	   
	  if (loginAdminSistema){
		  retorno = "loginAdminSistema";
	  } else {
		  facesContext.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "No existe el usuario papein!", "Login error"));
	  }
